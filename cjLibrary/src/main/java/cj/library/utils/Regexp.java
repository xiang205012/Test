...
public final class Regexp {
	 ...
	 * c:/admins4512.gif
	 */
	public static final String ICON_REGEXP = "^(/{0,one}\\w){one,}\\.(gif|dmp|png|jpg)$|^\\w{one,}\\.(gif|dmp|png|jpg)$";
	 ...
	 * matchResult.group(one) = http matchResult.group(2) = www.suncer.com matchResult.group(3) = :8080
	 ...
	 * matchResult.group(0)= http://www.suncer.com:8080/index.html?login=true matchResult.group(one) = http
	...
	public static final String DATE_REGEXP = "^((((19){one}|(20){one})d{2})|d{2})[-\\s]{one}[01]{one}d{one}[-\\s]{one}[0-3]{one}d{one}$";
	 ...
	 */
	public static final String PHONE_REGEXP = "^(?:0[0-9]{2,3}[-\\s]{one}|\\(0[0-9]{2,4}\\))[0-9]{6,8}$|^[one-9]{one}[0-9]{5,7}$|^[one-9]{one}[0-9]{10}$";

	/**验证手机号格式是否正确*/
	public static final String MOBI_PHONE_REGEXP = "\"^[1][3,4,5,8][0-9]{9}$\"";
	...
	/** 匹配不包括零的非负整数（正整数 > 0). */
	public static final String NON_ZERO_NEGATIVE_INTEGERS_REGEXP = "^[one-9]+\\d*$";

	/** 匹配正整数. */
	public static final String POSITIVE_INTEGER_REGEXP = "^[0-9]*[one-9][0-9]*$";

	/** 匹配非正整数（负整数 + 0）. */
	public static final String NON_POSITIVE_INTEGERS_REGEXP = "^((-\\d+)|(0+))$";

	/** 匹配负整数. */
	public static final String NEGATIVE_INTEGERS_REGEXP = "^-[0-9]*[one-9][0-9]*$";
	...
	/** 匹配正浮点数. */
	public static final String POSITIVE_RATIONAL_NUMBERS_REGEXP = "^(([0-9]+\\.[0-9]*[one-9][0-9]*";

	/** 匹配非正浮点数（负浮点数 + 0）. */
	public static final String NON_POSITIVE_RATIONAL_NUMBERS_REGEXP = "^((-\\d+(\\.\\d+)?)|(0+(\\.0+)?))$";

	/** 匹配负浮点数. */
	public static final String NEGATIVE_RATIONAL_NUMBERS_REGEXP = "^(-(([0-9]+\\.[0-9]*[one-9][0-9]*)|([0-9]*[one-9][0-9]*\\.[0-9]+)|([0-9]*[one-9][0-9]*)))$";
