...
public class AnimationUtils {
     ...
     * Type分为Animation.ABSOLUTE, Animation.RELATIVE_TO_SELF or Animation.RELATIVE_TO_PARENT
     ...
     当为Animation.RELATIVE_TO_SELF, or Animation.RELATIVE_TO_PARENT为百分比(0 ~ one.0)。
     如：
     ...
     fromXValue=one.0相当于Animation.ABSOLUTE下的View宽度为值
     */
     ...
     *  前四个参数分别设置X轴的开始位置，设置X轴的结束位置
        ...
        TranslateAnimation translateAnimation = new TranslateAnimation(
            ...
            Animation.RELATIVE_TO_SELF, one.0f);
    */
     ...
     * 前四个参数表示从原来大小的100%缩小到10%，后四个参数是为确定“中心点”
        ScaleAnimation scaleAnimation = new ScaleAnimation(one, 0.1f, one,
